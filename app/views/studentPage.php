...
<body class="min-h-screen flex items-center justify-center text-gray-100 font-sans p-4 sm:p-6 relative overflow-hidden">
  ...
  <!-- Main Container -->
  <div class="w-full max-w-6xl bg-gray-900/80 backdrop-blur-lg border border-gray-700 shadow-2xl rounded-2xl p-4 sm:p-8 flex flex-col lg:flex-row gap-6">

    <!-- Left Column (Form + Search) -->
    <div class="flex flex-col gap-4 w-full lg:w-1/3">

      <!-- Search Section -->
      <form method="POST" action="search" id="searchForm" class="flex flex-col sm:flex-row gap-3">
        <input
          type="text"
          id="searchbar"
          name="searchbar"
